'''
Code for fitting a voigt or power law curve to Monte Carlo Z0 data 
'''
...
if __name__ == "__main__":
    ...
    n, bins, patches = ax.hist(effmass, bins = 200, range = [110,140], density=False, alpha=0.3, label="Histogram of MC-Z0")

    bins = bins[:-1]
    
    
    popt, pcov = curve_fit(V, bins, n,  p0=[1.35105, 2.20259, 90.25890, 10000], maxfev = 7000)
    ...
    popt_power, pcov_power = curve_fit(power_series, bins, n, maxfev = 1000000, p0=[22770*300, 2.08, 90,])
